...
#include <stdlib.h>
        ...
        struct compra_gasolina                       /* Declaración de la estructura. */
        {
        char Cliente[20];
        int distancia;
        ...
        struct compra_gasolina a1 = {120, "María", "Contabilidad", 8.9, "Querétaro"}, a2, a3;
        ...
        printf("\nIngrese la matrícula del compra_gasolina 2: ");
        scanf("%d", &a2.matricula);
        fflush(stdin);
        printf("Ingrese el nombre del compra_gasolina 2:");
        gets(a2.nombre);
        printf("Ingrese la carrera del compra_gasolina 2: ");
        gets(a2.carrera);
